...
export default [
  new AudioPlayer(audioIds.button, new global.Audio(buttonSound), 0.3, false),
  new AudioPlayer(audioIds.toggle, new global.Audio(toggleSound), 1, false),
  new AudioPlayer(audioIds.lowPower, new global.Audio(lowPowerSound), 0.9, false),
  new AudioPlayer(audioIds.tabChange, new global.Audio(tabChangeSound), 0.5, false),
  new AudioPlayer(audioIds.titlesNav, new global.Audio(buttonSound), 0.2, false),
  new AudioPlayer(audioIds.meshIteration, new global.Audio(meshIterationSound), 0.4, false),
  new AudioPlayer(audioIds.researchComplete, new global.Audio(researchCompleteSound), 1, false),
  new AudioPlayer(audioIds.theEnd, new global.Audio(theEndSound), 0.7, true),
  new AudioPlayer(audioIds.incident, new global.Audio(incidentSound), 1, false),
  new AudioPlayer(audioIds.pause, new global.Audio(pauseSound), 1, false),
  new AudioPlayer(audioIds.start, new global.Audio(startSound), 1, false),
  new AudioPlayer(audioIds.computeZero, new global.Audio(computeZeroSound), 0.6, false),
  new AudioPlayer(audioIds.meshMode, new global.Audio(meshModeSound), 1, false)
]
