...
import {
  buyPowerAllowed, BuyPowerGrid, buyPowerLabel, BuyPowerSolar, BuyPowerWind, powerDemandString,
  powerSupplyId, powerSupplyName, powerSupplyString, supplyMutliplier
} from '../make/powerMechanic'
